...
def valid_train_set_split(folds, fold, train_np_ratio=1, valid_sub_ratio=1, train_sub_ratio=1, seed=None):
    ...
    valid_df_part_1_index = df_part_1_uic_label_cluster_pos[msk1_pos == 1].sample(frac=valid_sub_ratio,
                                                                                  random_state=seed)
    valid_df_part_1_index_neg = df_part_1_uic_label_cluster_neg[msk1_neg == 1]
    valid_df_part_2_index = df_part_2_uic_label_cluster_pos[msk2_pos == 1].sample(frac=valid_sub_ratio,
                                                                                  random_state=seed)
    ...
    train_df_part_1_index = df_part_1_uic_label_cluster_pos[msk1_pos == 0].sample(frac=train_sub_ratio,
                                                                                  random_state=seed)
    train_df_part_1_index_neg = df_part_1_uic_label_cluster_neg[msk1_neg == 0]
    train_df_part_2_index = df_part_2_uic_label_cluster_pos[msk2_pos == 0].sample(frac=train_sub_ratio,
                                                                                  random_state=seed)
...
def valid_train_set_construct(valid_ratio=0.5, valid_sub_ratio=0.5, train_np_ratio=1, train_sub_ratio=0.5, seed=None):
    ...
    valid_part_1_uic_label = valid_df_part_1_uic_label_cluster[valid_df_part_1_uic_label_cluster['class'] == 0].sample(
        frac=valid_sub_ratio, random_state=seed)
    ...
    train_part_1_uic_label = train_df_part_1_uic_label_cluster[train_df_part_1_uic_label_cluster['class'] == 0].sample(
        frac=train_sub_ratio, random_state=seed)
