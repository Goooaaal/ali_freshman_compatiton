...
df_user_count = pd.DataFrame.from_dict(user_count, orient='index', columns=['浏览', '收藏', '加购物车', '购买'])  # convert dict to dataframe)
df_user_count.to_csv("user_count.csv")  # store as csv file
