...
if __name__ == "__main__":
	...
	buyset = {}
	for line in sc.textFile('competition_tianchi/buy').collect():
		buyset[line.strip()] = True
	X_train_0, Y_train_0, X_train_1, Y_train_1 = [], [], [], []
	dates = ["12-15-0","12-16-0"]
	for date in dates:
		for line in sc.textFile('competition_tianchi/prediction/'+date).collect():
	...
	pred = "12-17-0"
	lines = sc.textFile('competition_tianchi/prediction/'+pred)
